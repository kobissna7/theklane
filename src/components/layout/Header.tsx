      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link to="/" className="absolute left-1/2 -translate-x-1/2">
            <span className="font-heading font-semibold text-lg tracking-[0.25em] uppercase text-brand-black">ƬӇЄ ƘԼΛƝЄ</span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to={user ? '/account' : '/account/login'} className="text-brand-charcoal hover:text-brand-black transition-colors" aria-label="Account">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
